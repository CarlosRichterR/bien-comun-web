            ...
            <DialogContent>
                ...
                {step === 'amount' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Este artículo cuesta Bs {(itemPrice * 6.96).toFixed(2)}. Ya se ha contribuido Bs {(contributedAmount * 6.96).toFixed(2)}.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="grid gap-4 py-4">
                            <Button onClick={() => setContributionAmount((fullContribution * 6.96).toFixed(2))}>
                                Contribuir el monto completo (Bs {(fullContribution * 6.96).toFixed(2)})
                            </Button>
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input
                                    ...
                                    placeholder={`Mínimo Bs ${(minContribution * 6.96).toFixed(2)}`}
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                            Monto de contribución seleccionado: Bs {(parseFloat(contributionAmount) * 6.96).toFixed(2)}
                        </p>
                        {error && (
                ...
                {step === 'qr' && (
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p>Escanee el código QR para realizar el pago de Bs {(parseFloat(contributionAmount) * 6.96).toFixed(2)}</p>
